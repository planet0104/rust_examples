use crate::neat::genes::{Genome, Innovation, LinkGene, NeuronGene};
use crate::neat::params;
use crate::neat::phenotype::NeuralNet;
use crate::neat::species::Species;
use crate::neat::utils::{random_float, random_int, random_usize};
use crate::win::ui;
