...
//返回-1 <n <1范围内的随机浮点数
pub fn random_clamped() -> f32{ rand::random::<f32>() - rand::random::<f32>() }
pub fn random_clamped_f64() -> f64{ rand::random::<f64>() - rand::random::<f64>() }
pub fn random_float() -> f32{ rand::random::<f32>() }
pub fn random_float_64() -> f64{ rand::random::<f64>() }
//返回[low, low] 区间的数
